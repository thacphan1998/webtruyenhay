            ...
            <form role="form" method="post" action="{{url('/create/user')}}">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input name="name" type="text" class="form-control" id="ten-nguoi-dung" placeholder="Nhập tên người dùng">
                </div>
                {{-- Email --}}
                <div class="form-group">
                  <label for="email">Email</label>
                  <input name="email" type="text" class="form-control" id="email" placeholder="Nhập email">
                </div>
                {{-- Mật khẩu --}}
                <div class="form-group">
