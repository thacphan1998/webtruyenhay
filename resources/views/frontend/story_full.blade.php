                ...
                <div class="left-content">
                    ...
                    <div class="row left-content-item">
                        <div class="col-md-12 first-title">
                            <h2 class="category-title">TRUYỆN FULL HAY NHẤT<i class="fas fa-chevron-right icon" style="font-size: 20px; margin-bottom: 2px;"></i></h2>
                        </div>
                        {{-- BEGIN: Danh sách truyện xem nhiều --}}
                        @foreach ($storiesfull as $storyItem)
