                ...
                <div class="left-content">
                            ...
                            <div class="w3-round sitemap" itemscope itemtype="#">
                                <div itemprop="itemListElement" itemscope itemtype="#" style="float: left;">
                                    ...
                                    <a href="{{url('/trang-chu')}}" itemprop="name" class="active">
                                        ...
                                        <span itemprop="name"> Truyện yêu thích </span>
                                    </a>
                    ...
                    <div class="row left-content-item">
                        <div class="col-md-12 first-title">
                            <h2 class="category-title">TRUYỆN ĐÃ ThÍCH<i class="fas fa-chevron-right icon" style="font-size: 20px; margin-bottom: 2px;"></i></h2>
                        </div>
                        @foreach ($list_story_liked as $storyItem)
                            ...
                            <div class="col-sm-3 row-number">
                                <div>
                                    ...
                                    <span class="row-time">
                                        ...
                                        <span class="time-ago">{{str_replace('day ago','ngày trước',$storyItem->created_at)}}</span>
                                    </span>
                                </div>
                            </div>
                        </div>
