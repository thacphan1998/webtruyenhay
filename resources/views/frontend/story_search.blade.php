                ...
                <div class="left-content">
                    ...
                    <div class="row left-content-item">
                        <div class="col-md-12 first-title">
                            <h2 class="category-title">Danh sách truyện tìm kiếm<i class="fas fa-chevron-right icon" style="font-size: 20px; margin-bottom: 2px;"></i></h2>
                        </div>
                        {{-- BEGIN: Danh sách truyện tìm kiếm --}}
                        @foreach ($storiesFiltered as $storyItem)
                        ...
                        @endforeach
                        {{-- END: Danh sách truyện tìm kiếm --}}
                        @if(count($storiesFiltered) == 0)         
