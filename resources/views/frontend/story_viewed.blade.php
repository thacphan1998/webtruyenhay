                ...
                <div class="left-content">
                    ...
                    <div class="row left-content-item">
                        <div class="col-md-12 first-title">
                            <h2 class="category-title">TRUYỆN ĐÃ XEM<i class="fas fa-chevron-right icon" style="font-size: 20px; margin-bottom: 2px;"></i></h2>
                        </div>
                        @foreach ($list_story_viewed as $storyItem)
